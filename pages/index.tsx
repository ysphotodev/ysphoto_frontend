        ...
        <div className="pt-16  container mx-auto gallery_container  bg-white ">
          <div>
            <div className="grid-cols-1 xl:grid-cols-2 grid  sm:py-5    items-center ">
              ...
              <p
                  className={`${roboto.className}  mx-auto p-5 bg-white text-black   underline   max-w-[600px] break-keep  text-left  text-[2rem] sm:text-[3.5rem] uppercase ${monts.className} `}
              >
