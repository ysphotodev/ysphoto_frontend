...
export default function AdvertismentPage({ posts }:{posts:{
    attributes:{
      Title:string,
      URL:string,
    }
      ...
      >
        ...
        <div className="pt-16 sm:py-20 container mx-auto gallery_container ">
          <div className=" flex flex-col  ">
            ...
            {/*  {posts.map((post) => (*/}
            {/*    <Image*/}
            {/*      className="w-full h-56 object-cover hover:rounded-3xl hover:ease-in-out hover:tracking-tight hover:scale-125 hover:duration-75"*/}
            {/*      key={post.id}*/}
...
const data = await fetch('https://ys-api.sh-dev.xyz/api/advertisments?pagination[start]=0&pagination[limit]=200',{
    headers:{
